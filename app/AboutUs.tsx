    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-1/2 " id="about-us">
            ...
            <div className="about-us-text p-4 md:p-0">
                <h2 className="text-3xl  sm:text-3xl xl:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-lime-500 to-emerald-400 selection:bg-pink-400 selection:text-white">About Us</h2>
